...
## Captured User Request (Math App)

When the user asks for help with this project, preserve and use these requirements:

1. User is a 10-year-old learner.
2. Build a math app with a UI.
3. Teach arithmetic, algebra, and calculus.
4. Teach with stories.
5. User clicks a button when done reading.
6. Then provide problems to solve.
7. User solves on pencil and paper.
8. User enters answer; app checks right or wrong.
9. App tracks and scores points.
10. Include difficulty levels.
11. Include badges and stars.
12. Make it a desktop application using HTML, JavaScript, and CSS.
13. Generate new stories and new problems every time for the same subject.
14. Continue same-subject practice until the learner reaches expert level.
